...
<head lang="en">
    ...
    <link rel="stylesheet" href="http://localhost:8080/UserAction/css/error404.css">
    ...
    <script type="text/javascript" src="http://localhost:8080/UserAction/js/error404.js"></script>
</head>
<body>
<!--500出错后显示页面-->
<div id="body">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-8 col-sm-6 col-md-4 col-md-offset-4 col-sm-offset-3 col-xs-offset-2">
                <a href="#">
	                <button class="errorDiv btn-lg btn-danger col-xs-12 col-sm-12 col-md-12">
	                    	500服务器端发生错误！点击返回首页。
	                </button>
                </a>
            </div>
