...
<head lang="en">
    ...
    <link rel="stylesheet" href="../../../css/data/scoreAnalysis.css">
    ...
    <script type="text/javascript" src="../../../js/data/scoreAnalysis.js" charset="UTF-8"></script>
</head>
<body>
<!--后台可视化数据查看首页-->
<!--用ajax显示右边内容-->
        ...
        <%@ include file="left.jsp" %>
            ...
            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
                <div id="tab" class="row">
                    <div id="aveScore" class="col-xs-12 col-sm-12 col-md-6 col-lg-12">
                        <!--这里放各个学院、男女平均得分的柱状图-->
                    </div>
                </div>
                <hr>
                ...
                <hr>
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-18">
                    </div>
                </div>
                <hr>
            </div>
